...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header d-flex justify-content-between align-items-center bg-gradient-purple text-white">
            <h3 class="fw-bold">Sub-SubCategories List</h3>
            <a href="{{ route('admin.subsubcategories.create') }}" class="btn btn-success">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted">No Sub-SubCategories found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
