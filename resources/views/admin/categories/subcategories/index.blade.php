    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-cyan-600 px-6 py-4 text-white">
                <h3 class="text-xl font-semibold tracking-wide">SubCategories List</h3>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-5 py-3">
                                ...
                                <img src="{{ asset('storage/' . $subCategory->image) }}" class="w-12 h-12 object-cover rounded-full">
                                @else
                                <span class="text-gray-400 italic">No Image</span>
                                @endif
                            </td>

                            <td class="px-5 py-3 text-gray-800 font-medium">{{ $subCategory->name }}</td>
                        ...
                        <tr>
                            <td colspan="6" class="px-5 py-6 text-center text-gray-500">No subcategories found.</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
            ...
            <div class="md:hidden divide-y divide-gray-100">
                ...
                <div class="p-4 hover:bg-gray-50 transition">
                    <div class="flex justify-between items-center mb-2">
                        <h4 class="text-gray-800 font-semibold text-base">{{ $subCategory->name }}</h4>
                        <div class="flex gap-2">
                            ...
                            <form id="delete-form-mobile-{{ $subCategory->id }}"
                                action="{{ route('admin.subcategories.destroy', $subCategory->id) }}" method="POST"
                                class="hidden">
                                @csrf
                                @method('DELETE')
                ...
                @if($subCategories->isEmpty())
                <div class="p-6 text-center text-gray-500">No subcategories found.</div>
                @endif
            </div>
